...
uint256 hashGenesisBlock("0xf7bdb65bd8e0eb12fc65e88578db169938bf83962e513e7ff37bc596346c0511");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // FaldoranScrypt: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FaldoranScrypt Signed Message:\n";
...
{
    // FaldoranScrypt: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // FaldoranScrypt: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FaldoranScrypt: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // FaldoranScrypt: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf7bdb65bd8e0eb12fc65e88578db169938bf83962e513e7ff37bc596346c0511");
    }
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FaldoranScryptMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FaldoranScryptMiner : ProcessBlock, block not accepted");
    }
...
void static LitecoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running FaldoranScrypt with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FaldoranScryptMiner terminated\n");
        throw;
    }
}
